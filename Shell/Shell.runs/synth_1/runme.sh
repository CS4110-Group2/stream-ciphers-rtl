...
HD_PWD='/home/kent/source/vhdl/Shell/Shell.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Shell.tcl
